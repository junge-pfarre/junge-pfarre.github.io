...
xhr.addEventListener 'readystatechange', ->
  if xhr.readyState is 4                                    #ReadyState Complete
    ...
    console.log(allEvents[1].startDate.toJSDate().toLocaleString())
    console.log(allEvents[2].startDate.toJSDate().toLocaleString())
    console.log(allEvents[1].startDate.toJSDate() > allEvents[2].startDate.toJSDate())
    allEvents.sort((a, b) ->
